    ...
    <div class="_uiView--content">
      ...
      <div class="_buttonsDemo">
        <button
          ...
          @click="toggleAllActive"
        >
          Long text button with a long text that should wrap to the next line
          and not be cut off at the end of the button
        </button>
      </div>
      ...
      <h3>
        Input types (color, date, datetime-local, email, month, number,
        checkbox, password, search, tel, text, time, url, week)
      </h3>
      <div class="_inputsDemo">
        <div>
          <label>color</label>
      ...
      <div class="u-warning">
        Test warning on multiple lines Test warning on multiple lines Test
      ...
      >
        <div>
          ...
          <p>
            ...
            efficitur erat pulvinar id. Sed nec arcu nec est sagittis finibus
            non eget mauris. Donec ornare lectus quis bibendum gravida.
            Vestibulum quis laoreet purus. Ut semper, justo ut malesuada
            aliquam, velit arcu consequat erat, eu lacinia orci orci eu sem. Sed
            sodales tristique nunc, in lobortis sapien pulvinar non. Nam luctus
            euismod justo quis semper. Fusce sit amet tortor ut odio dignissim
            ultrices vel nec ligula. Nunc odio nulla, rutrum a tristique non,
            porttitor vel massa. Integer eget pulvinar orci.
          </p>
          <figure>
            <img
            ...
            <figcaption>
              <p>
                ...
                malesuada aliquam, velit arcu consequat erat, eu lacinia orci
                orci eu sem. Sed sodales tristique nunc, in lobortis sapien
                pulvinar non. Nam luctus euismod justo quis semper. Fusce sit
                amet tortor ut odio dignissim ultrices vel nec ligula. Nunc odio
                nulla, rutrum a tristique non, porttitor vel massa. Integer eget
                pulvinar orci.
              </p>
            </figcaption>
          </figure>
