...
var dodoc = (function() {
  ...
  const API = {
    init               : ()   => { return init() },
    setCurrentLang     : (codeLang)   => { return setLang(codeLang) },
  ...
  function init() {
    // use current default lang (to override, call setLang with a codeLang before init
    var langToLoad = currentLang;
    ...
    if(langToLoad === 'fr') {
      ...
      lang = {
          ...
          "mediapublitemplatesarestoredint" : "Contents are stored in: ",
